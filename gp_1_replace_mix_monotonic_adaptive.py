...
class GPPdf:
        ...
        while self.generation <= self.max_gen:
            ...
            for i in range(len(self.popul)):
                if i not in self.vid_from_trace:
                    ...
                    try:
                        self.popul[i] = PdfGenome.mutation_del_move(self.exploit_source, self.popul[i], self.mut_rate, self.ext_genome)
                    except Exception, e:
    ...
    def initial_population(self):
        ...
        while len(popul) < int(self.pop_size):
            ...
            root = PdfGenome.mutation_del_move(self.exploit_source, root, self.mut_rate, self.ext_genome)
            popul.append(root)
        return popul
...
if __name__ == "__main__":
    ...
    if classifier_name == 'pdfrate':
        ...
        from lib.fitness import fitness_ensemble as fitness_func
